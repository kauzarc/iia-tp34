...
public class OtherGameBoard implements IBoard<OtherGameMove, OtherGameRole, OtherGameBoard> {
	...
	private Map<OtherGameMove, List<OtherGameMove>> graph = Map.ofEntries(
			...
			Map.entry(new OtherGameMove("K"), Arrays.asList(new OtherGameMove("3"), new OtherGameMove("9"))),
			Map.entry(new OtherGameMove("L"), Arrays.asList(new OtherGameMove("1"), new OtherGameMove("8"))),
			Map.entry(new OtherGameMove("M"), Arrays.asList(new OtherGameMove("6"), new OtherGameMove("20"))),
			Map.entry(new OtherGameMove("N"), Arrays.asList(new OtherGameMove("0"), new OtherGameMove("13"))),
			Map.entry(new OtherGameMove("O"), Arrays.asList(new OtherGameMove("2"), new OtherGameMove("4"))),
			Map.entry(new OtherGameMove("P"), Arrays.asList(new OtherGameMove("1"), new OtherGameMove("5"))),
			Map.entry(new OtherGameMove("Q"), Arrays.asList(new OtherGameMove("2"), new OtherGameMove("8"))),
			Map.entry(new OtherGameMove("R"), Arrays.asList(new OtherGameMove("21"), new OtherGameMove("14"))),
			Map.entry(new OtherGameMove("S"), Arrays.asList(new OtherGameMove("2"), new OtherGameMove("4"))),
			Map.entry(new OtherGameMove("T"), Arrays.asList(new OtherGameMove("7"), new OtherGameMove("5"))),
			Map.entry(new OtherGameMove("U"), Arrays.asList(new OtherGameMove("8"), new OtherGameMove("13"))),
			Map.entry(new OtherGameMove("V"), Arrays.asList(new OtherGameMove("11"), new OtherGameMove("4"))));
	// ---------------------- Constructors ---------------------

	public OtherGameBoard() {
		this.head = new OtherGameMove("A");
