...
public class NimGame extends AbstractGame<NimMove, NimRole, NimBoard> {
	...
	public static void main(String[] args) {
		...
		GameAlgorithm<NimMove, NimRole, NimBoard> alg1 = new MiniMax<NimMove, NimRole, NimBoard>(role1, role2,
				NimHeuristics.player1, 2);
		GameAlgorithm<NimMove, NimRole, NimBoard> alg2 = new MiniMax<NimMove, NimRole, NimBoard>(role2, role1,
				NimHeuristics.player2, 4);
