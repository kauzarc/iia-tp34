...
public class NimGame extends AbstractGame<NimMove, NimRole, NimBoard> {
	...
	public static void main(String[] args) {
        ...
        GameAlgorithm<NimMove, NimRole, NimBoard> alg1 = new AlphaBeta<NimMove, NimRole, NimBoard>(
            role1, role2, NimHeuristics.player1, 1);
		GameAlgorithm<NimMove, NimRole, NimBoard> alg2 = new AlphaBeta<NimMove, NimRole, NimBoard>(
            role2, role1, NimHeuristics.player2, 20);
